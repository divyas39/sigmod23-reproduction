...
def run_callback_parameter_simulation_and_postprocess(
    ...
    shots=10240,
    opt_time_ms=0.0,
    base_dir="./Week88/ExperimentalAnalysis/IBMQ/QPUPerformance/Results/CPU_Data",
    trial_id=1,
    tag=4,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--optimizer_name", type=str, default="COBYLA")
    parser.add_argument("--iterations", type=int, default=10000)
    parser.add_argument(
        "--base_dir",
        type=str,
        default="/workspace/Week88/ExperimentalAnalysis/IBMQ/QPUPerformance/Results/CPU_Data",
    )
    parser.add_argument(
        "--pickle_base",
        type=str,
        default="/workspace/base/ExperimentalAnalysis/IBMQ/QPUPerformance/Results/CPU_Data",
    )

    args = parser.parse_args()

    input_id = args.input_idx
    trial = args.trial
    reps = args.reps
    current_optim = args.optimizer_name
    iterations = args.iterations
    base_dir = args.base_dir
    pickle_base = args.pickle_base
    ...
    result_path_prefix = pickle_base
    ...
    for trial in [trial]:
        ...
        batch_run_callback_history_and_postprocess(
            ...
            current_optim=current_optim,
            iterations=iterations,
            input_id=input_id,base_dir=base_dir,
        )
